...
<html>
    ...
    <body>
        ...
        <div id="edit-reservation" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.reservation}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.reservation}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.reservation}" method="PUT">
                <g:hiddenField name="version" value="${this.reservation?.version}" />
                <fieldset class="form">
